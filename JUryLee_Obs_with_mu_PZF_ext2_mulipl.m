...
%%%%%%%%%%% for b = 0.5 ----> all r %%%%%%%%
%%%%%%%%%%% for r = 0.1 ----> b = 0.4984 %%%%%%%
%%%%%%%%%%% for n = 10    ----> b = 0.5098 %%%%the most I can get
dpar1 = 0.001;
dpar2 = 0.001;
kk=2.4;
for par1 =.1
    ...
    for par2 = 0.;%0.715:dpar2:1
        ...
        %
        Gold=G;
        G=[daug(eye(np)*par2,-kk*F)]*[zeros(np,np),G;Jy*eye(np),Ju+Jy*G]*[daug(eye(np)*par2,E)];
        [sys,g] = balreal(G);
