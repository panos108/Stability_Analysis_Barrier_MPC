...
%%%%%%%%%%% for b = 0.5^2=0.25 ----> r = 3.994 %%%%%%%%
%%%%%%%%%%% for r = 0.001 ----> b = not even nominal stabolity %%%%%%%
for par1=0.1%3.994:-0.001:3.9;%2.8;2.8
    k=par1;
    pp1=pp1+1;
    pp2=0;
    for par2=0.3:0.001:10%0.5
        pp2=pp2+1;
%%% Define system %%%
z=tf('z');
%%% Gain for plant %%%
...
%         
        Gold=G;
        G=[daug(eye(np)*0,-F*par2)]*[zeros(np,np),G;Jy*eye(np),Ju+Jy*G]*[daug(eye(np)*0,E)];
        [sys,g] = balreal(G);
